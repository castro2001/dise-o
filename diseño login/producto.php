...
$fichero= (isset($_FILES['subir']['name']))?$_FILES['subir']['name']:"";
...
switch ($accion) {
    case 'agregar':
      ...
      //INSERT INTO `libros`(`id`, `nombre`, `imagen`, `archivos`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]')
       $sentenciaSQL=$conexion->prepare("INSERT INTO libros(nombre, imagen, archivos) VALUES (:nombre,:imagen , :archivos);");
        ...
        //archivo
        $nombreFichero=($fichero!="")?$fecha->getTimestamp()."_".$_FILES["subir"]["name"]:"archivo.pdf";
        $tmpFichero= $_FILES["subir"]["tmp_name"];
        ...
        if ($fichero!=""){          
        move_uploaded_file($tmpFichero, "../../archivos/".$nombreFichero);
       }   

        $sentenciaSQL->bindParam(':archivos',$nombreFichero);
    ...
    <div class="card">
        ...
        <div class="card-body">
          <form method="POST"  enctype="multipart/form-data">
            ...
            <!-- inicio de cargar archivos -->
            <div class = "form-group">
                <label for="subir">file:</label>
                <input type="file" required class="form-control" value="<?php echo $fichero;?>" name="subir" id="subir"  placeholder="nombre">
            </div>
